// src/app/ProductsDetail.tsx   ( All Products Page )
...
export default async function ProductsDetail() {
  ...
  return (
    <div className="bg-black">
      ...
      <h1 className="text-3xl text-center lg:text-7xl font-bold mt-4 text-fuchsia-400 hover:scale-y-150 hover:text-white">HEAVEN HILLS PRODUCTS</h1>
      </div>
      {products.length > 0 ? (
