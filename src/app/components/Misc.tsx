  ...
  return (
    <div className="bg-gray-200 min-h-screen">
      <main className="container mx-auto py-10">
        <h2 className="text-3xl font-bold mb-8 text-center text-black hover:text-red-500 hover:scale-y-150">Our Blogs</h2>
        <p className="text-center text-sm md:text-lg lg:text-xl mb-8 text-black hover:text-blue-600 hover:scale-y-150 md:hover:scale-y-150 lg:hover:scale-y-150">Find a bright idea to suit your taste with our great selection</p>
